...
import SmartContractJob from "../components/smartContractJobMeshJsForExample";
...
const SmartContracts = () => {
  ...
  return (
    <Box sx={{ m: 2, display: "flex", flex: 1, flexDirection: "column" }}>
      <Typography variant="h6" gutterBottom>
        PAAS demo dApps with fetched smart contracts
      </Typography>
